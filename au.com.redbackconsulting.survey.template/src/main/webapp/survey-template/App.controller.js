...
//					modelCreateSurvey.setDefaultBindingMode("OneWay");
						...
						bus.subscribe("nav", "toContent", this.contentHandler, this);
					...
					contentHandler : function (channelid, eventId, data){
 						var key = data.id;	
						alert("contentHandler"+key);
						if (this.app.getPage(data.id) === null) {
							var fullViewName = this.getViewName('leftnavi');
...
//						else {
//							var leftNaviView =this.app.getPage(data.id);
//						var rightPanel =leftNaviView.getById("");
//						rightPanel.destroyContent();
//						
//						}
//							
						...
						this.app.to('leftnavi', "show", page);
					},
					...
					mainmenuSelectHandler : function(evt) {
